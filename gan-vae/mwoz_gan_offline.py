...
from gan.gan_agent import GanRnnAgent, GanAgent_SAT, GanAgent_SAT_WoZ
from gan.torch_utils import  weights_init
from gan.utils import load_context_encoder, load_action2name, save_data_for_tsne
...
method_arg.add_argument('--input_type', type=str, default='sat', help="sa: state_action, sat: gumble representation")
...
net_arg.add_argument('--state_noise_dim', type=int, default=200)  
net_arg.add_argument('--action_noise_dim', type=int, default=200)  
...
net_arg.add_argument('--vae_embed_size', type=int, default=680)  
